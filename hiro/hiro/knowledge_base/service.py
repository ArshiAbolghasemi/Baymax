...
from hiro.clients.embedding import EmbeddingClient
...
from hiro.knowledge_base import repository as repo
from hiro.knowledge_base.models import AnswerQuestion
from hiro.knowledge_base.schemas import (
    PairRead,
    QACreate,
    QAStatus,
    QuestionRead,
